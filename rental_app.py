...
<style>
    ...
    th, td { border: 1px solid rgba(128, 128, 128, 0.2); padding: 6px 4px; text-align: center; vertical-align: middle; }
    
    /* 열 너비 비율: 시간/인원/상태 최소화, 장소:부서(4:5), 행사명(기준) */
    th:nth-child(1), td:nth-child(1) { width: 16%; }  /* 장소 (4) */
    th:nth-child(2), td:nth-child(2) { width: 100px; } /* 시간 */
    th:nth-child(3), td:nth-child(3) { width: 45%; }  /* 행사명 (기준) */
    th:nth-child(4), td:nth-child(4) { width: 45px; }  /* 인원 */
    th:nth-child(5), td:nth-child(5) { width: 20%; }  /* 부서 (5) */
    th:nth-child(6), td:nth-child(6) { width: 50px; }  /* 상태 */
