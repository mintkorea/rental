...
st.markdown("""
    ...
    .card-first-line { display: flex; justify-content: space-between; align-items: center; gap: 10px; }
    .place-name { font-weight: bold; color: #333; font-size: 15px; flex: 1; min-width: 0; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
    ...
    .card-second-line { font-size: 12px; color: #666; margin-top: 2px; line-height: 1.2; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
    
    /* 가로 모드 표 스타일 정의 (폰트 조절 로직은 column_config에서 처리) */
