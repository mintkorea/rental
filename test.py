...
st.markdown("""
    ...
    /* 사이드바 너비 및 선택 박스 스타일 강제 조정 */
    section[data-testid="stSidebar"] { min-width: 320px !important; max-width: 350px !important; }
    .stMultiSelect div[data-baseweb="select"] { min-height: 45px !important; }
    .stMultiSelect span { white-space: nowrap !important; font-size: 13px !important; }
