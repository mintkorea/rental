...
# 1. 디자인 및 홈페이지 텍스트 제어 (2행 제한 및 폰트 축소)
...
st.markdown("""
    ...
    /* [가이드라인] 홈페이지 행사명 2행 제한 및 폰트 축소 로직 */
...
def get_data(s_date, e_date):
    ...
    try:
            ...
            while curr <= e:
                if s_date <= curr <= e_date:
                    rows.append({
                        ...
                        'reservationSeq': item.get('reservationSeq'), # 고유 식별자 활용
        ...
        # 날짜와 예약번호를 결합하여 완벽한 중복 제거 (3/16 성의회관 2건 보장)
