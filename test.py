...
<style>
    ...
    /* 모바일 헤더 및 텍스트 스타일 복구 */
    h3 { margin-top: 20px !important; margin-bottom: 10px !important; font-size: 1.4rem !important; }
    h4 { margin-top: 15px !important; margin-bottom: 5px !important; color: #1e3a5f !important; font-size: 1.1rem !important; }
</style>
...
def create_formatted_excel(df, selected_buildings):
    ...
    with pd.ExcelWriter(output, engine='xlsxwriter') as writer:
        ...
        worksheet.set_column('B:B', 14) # 시간 셸 +2
                ...
                if v_mode == "PC":
                    ...
                    for _, r in b_df.iterrows():
                        ...
                        <div style="border-bottom:1px solid #eee; padding:8px 0;">
                            ...
                            <div style="font-size:12px; color:#666; margin-top:2px;">{r['행사명']} ({r['부서']}, {r['인원']}명)</div>
                        </div>
                        """, unsafe_allow_html=True)
else:
